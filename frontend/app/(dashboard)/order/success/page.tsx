    ...
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-brown-light">Loading order details...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-cream py-8 px-4">
      <div className="container mx-auto max-w-4xl">
        {/* Success Header */}
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-6 text-center relative overflow-hidden" style={{ borderRadius: '20px' }}>
          {isCancelled ? (
             <>
            ...
            <>
              <CheckCircle2 className="h-16 w-16 text-sage mx-auto mb-4" strokeWidth={1.5} />
              <h1 className="text-3xl font-bold text-brown mb-2">
                Order Placed Successfully!
              </h1>
              <p className="text-brown-light mb-1">
                Thank you for your purchase. Your order reference is{" "}
                <span className="font-bold text-brown">{orderReference}</span>.
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <Card className="border-line rounded-2xl" style={{ borderRadius: '20px' }}>
            <CardHeader className="pb-4 flex flex-row items-center justify-between">
              <CardTitle className="text-xl text-brown">Order Summary</CardTitle>
              <div className="px-3 py-1 bg-sand rounded-full text-xs font-medium text-brown-light uppercase">
                {order.status}
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="border-t border-line pt-4 mt-4">
                <div className="flex justify-between text-lg font-bold">
                  ...
                  <p className="text-terracotta">${order.totalPrice.toFixed(2)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          {!isCancelled && (
            <Card className="border-line flex flex-col rounded-2xl" style={{ borderRadius: '20px' }}>
              <CardHeader className="pb-4 flex flex-row items-center justify-between">
                <CardTitle className="text-xl text-brown">Payment Instructions</CardTitle>
                
                {/* Change Payment Method Dialog */}
                {isCancellable && (
                  <Dialog open={paymentDialogOpen} onOpenChange={setPaymentDialogOpen}>
                    <DialogTrigger asChild>
                      <Button variant="ghost" size="sm" className="text-terracotta hover:text-terracotta hover:bg-terracotta/10 h-8 gap-1">
              ...
              <CardContent className="space-y-4 flex-1">
                {order.paymentMethod === "CASH_ON_DELIVERY" ? (
                  <p className="text-gray-600">
                    ...
                    <span className="font-bold text-terracotta">${order.totalPrice.toFixed(2)}</span>{" "}
                  ...
                  <>
                    <p className="text-gray-600">
                      Please send{" "}
                      <span className="font-bold text-terracotta">${order.totalPrice.toFixed(2)}</span> via{" "}
                             ...
                             <div className="pl-7 space-y-2">
                               ...
                               <div className="flex justify-between items-center bg-white p-2 rounded border border-gray-100">
                                  ...
                                  <div className="flex items-center gap-2">
                                    <span className="font-mono font-medium text-terracotta">{platformDetails.ecocashNumber}</span>
                                    <button
                           ...
                           <div className="space-y-3">
                             ...
                             <div className="pl-7 space-y-2">
                               ...
                               <div className="flex justify-between items-center bg-white p-2 rounded border border-gray-100">
                                  ...
                                  <div className="flex items-center gap-2">
                                    <span className="font-mono font-medium text-terracotta">{platformDetails.bankAccountNumber}</span>
                                    <button
                  ...
                  <div key={seller.id} className="space-y-2">
                    {seller.whatsappNumber && (
                      <a
                        ...
                        className="flex items-center justify-center gap-2 w-full py-3 border-2 border-terracotta text-terracotta rounded-xl hover:bg-terracotta/5 transition-colors font-medium"
                      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Link href="/my-orders">
            <Button className="w-full sm:w-auto bg-terracotta hover:bg-brown text-white rounded-full">
              View My Orders
            </Button>
          </Link>
