  ...
  return (
    <div className="space-y-4">
      ...
      {stats && stats.users.pendingSellers > 0 && (
        <div className="bg-terracotta/10 border border-terracotta/30 rounded-lg p-3 flex items-start gap-2">
          <AlertCircle className="w-4 h-4 text-terracotta mt-0.5 shrink-0" />
          <div className="flex-1">
            <p className="text-terracotta font-medium text-sm">Pending Actions Required</p>
            <p className="text-terracotta/80 text-xs mt-0.5">
              You have {stats.users.pendingSellers} pending seller verification(s) waiting for review
            </p>
          </div>
          <Link
            href="/admin/sellers/pending"
            className="px-3 py-1.5 bg-terracotta hover:bg-terracotta/90 text-gray-900 rounded-md text-xs font-medium transition-all"
          >
            Review Now
          </Link>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {/* Total Users */}
        <div className="bg-white border border-gray-200 rounded-lg p-4 hover:border-brown transition-all shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <div className="p-2 bg-brown/10 rounded-md">
        ...
        {/* Total Sellers */}
        <div className="bg-white border border-gray-200 rounded-lg p-4 hover:border-sage transition-all shadow-sm">
          <div className="flex items-center justify-between mb-2">
          ...
          {stats && stats.users.pendingSellers > 0 && (
            <p className="text-terracotta text-[10px] mt-1">
        ...
        {/* Total Products */}
        <div className="bg-white border border-gray-200 rounded-lg p-4 hover:border-terracotta transition-all shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <div className="p-2 bg-terracotta/10 rounded-md">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 hover:border-brown transition-all shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <div className="p-2 bg-cream rounded-md">
              <ShoppingCart className="w-4 h-4 text-brown" />
            </div>
          ...
          <p className="text-sage text-[10px] mt-1">
      ...
      <div className="grid grid-cols-3 gap-4">
        {/* Today's Revenue */}
        <div className="bg-linear-to-br from-brown to-sage rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
          ...
          <p className="text-cream text-xs">Today&apos;s Revenue</p>
        ...
        {/* This Week */}
        <div className="bg-linear-to-br from-sage to-sage rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="p-2 bg-white/10 rounded-md">
        ...
        {/* This Month */}
        <div className="bg-linear-to-br from-terracotta to-orange-500 rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="p-2 bg-white/10 rounded-md">
              <DollarSign className="w-4 h-4 text-gray-900" />
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link
              href="/admin/orders"
              className="text-brown hover:text-sage text-xs font-medium"
            >
              View All →
            </Link>
          </div>
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p className={`text-[10px] mt-0.5 ${
                    ...
                    order.status === 'Shipped' ? 'text-brown' :
                    order.status === 'Paid' ? 'text-sage' :
                    'text-terracotta'
                  }`}>
                    {order.status}
                  </p>
            ...
            {recentActivity?.recentUsers.slice(0, 5).map((user) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-brown flex items-center justify-center text-white text-[10px] font-bold">
                ...
                <div className="flex gap-1.5 items-center">
                  {user.isSeller && (
                    <span className="px-1.5 py-0.5 bg-sage/10 text-sage text-[10px] rounded">
                      Seller
                    </span>
                  )}
                  {user.isVerified && (
