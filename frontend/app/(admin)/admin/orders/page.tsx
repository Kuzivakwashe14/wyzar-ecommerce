  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-400">Manage all orders on the platform</p>
      </div>

      {/* Stats */}
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        {['Pending', 'Paid', 'Shipped', 'Delivered', 'Cancelled'].map((status) => (
          <div key={status} className="bg-slate-950 border border-slate-800 rounded-lg p-4">
      ...
      <div className="bg-slate-950 border border-slate-800 rounded-xl p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="text-sm text-slate-400 flex items-center justify-end">
            Total Orders: <span className="text-white font-bold ml-2">{totalOrders}</span>
          </div>
        </div>
      </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-slate-800">
                  {orders.map((order) => (
                    <tr key={order._id} className="hover:bg-slate-900 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div>
                          ...
                          <p className="text-slate-400 text-xs">{order.user?.phone}</p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-right">
                        <select
                          ...
                          className="px-3 py-1 bg-slate-700 border border-slate-600 rounded-lg text-white text-sm focus:outline-none focus:border-indigo-500"
                        >
                          <option value="Pending">Pending</option>
                          <option value="Paid">Paid</option>
                          <option value="Shipped">Shipped</option>
